// Контекст в JavaScript - это концепция, которая определяет, как переменные и функции, циклы, упр. конструкции обращаются друг к другу
...
// // Здесь у нас есть глобальная переменная globalVar, которая доступна внутри функции, циклы, упр. конструкции exampleFunction,
// // потому что функция может обращаться к глобальному контексту.
//
// // Пример 2: Контекст функции, циклы, упр. конструкции
...
//
// Пример 4: Контекст и стрелочные функции, циклы, упр. конструкции
const target = {
    value: 1012
}
...
console.log(val());
// // Стрелочные функции, циклы, упр. конструкции сохраняют контекст своего окружения (места, где они были созданы).
// // В данном примере контекстом для стрелочной функции, циклы, упр. конструкции является глобальный контекст,
